...
/* ---------------------------------------------------------------------- */
	...
	/* ---------------------------------------------------------------------- */
	// LoggyAppender - logs data to clod using Loggy

	function LoggyAppender() {}

	LoggyAppender.prototype = new log4javascript.Appender();
	LoggyAppender.prototype.layout = new NullLayout();
	LoggyAppender.prototype.threshold = Level.DEBUG;

	LoggyAppender.prototype.append = function(loggingEvent) {
		var appender = this;
	...
	LoggyAppender.prototype.groupEnd = function() {
		if (window.console && window.console.groupEnd) {
			window.console.groupEnd();
		}
	};

	LoggyAppender.prototype.toString = function() {
		return "LoggyAppender";
	};

	log4javascript.LoggyAppender = LoggyAppender;
	/* ---------------------------------------------------------------------- */	
