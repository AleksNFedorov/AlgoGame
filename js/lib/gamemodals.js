...
GameModal = function (game) {
    ...
    this.hideModal = function (type) {
        ...
        // Adding graphics to group issue work around
        game.modals[type].modal.visible = false;
    };
    ...
    return {
        ...
        createModal: function (options) {
            ...
            var hideCallback = options.hideCallback || function(){};
            ...
            for (var i = 0; i < itemsArr.length; i += 1) {
                ...
                if (itemType === "text" || itemType === "bitmapText") {
                    ...
                    modalLabel = game.add.image(0, 0, content, item.imageFrame);
        ...
        showModal: function (type) {
            ...
            // Adding graphics to group issue work around
            game.modals[type].modal.visible = true;
