...
module Common {   
    ...
    class ControlPanel extends GameComponentContainer {
        ...
        createElements(): void {
            ...
            this.addGameElement(Common.GameElements.CONTROL_PANEL_BUTTON_PLAY, this._playButton);
    ...
    export class PractisePanel extends ControlPanel {
       ...
       createElements():void {
            ...
            this.addGameElement(Common.GameElements.CONTROL_PANEL_BUTTON_PAUSE, this._pauseButton);
