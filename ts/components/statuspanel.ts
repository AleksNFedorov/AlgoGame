...
module Common {
    ...
    export enum GameResult {Win, Fail, ComputerWin};
    ...
    export class StatusPanel extends GameEventComponent {
        ...
        private createStatusPanel(type: GameResult, headlineStyle: any, subHeadlineStyle: any): Phaser.Group {
            ...
            var headLineTextValue = Dictionary[GameResult[type] + "HeadLine"];
            var subHeadLineTextValue = Dictionary[GameResult[type] + "SubHeadLine"];
            ...
            subHeadLineText.x = headLineText.width/2 - subHeadLineText.width/2;
